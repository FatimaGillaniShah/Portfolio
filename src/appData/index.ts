...
export const serviceData = [
  ...
  },
  {
    ...
    shortDescription: 'Image and file storage using Cloudinary’s cloud solution.',
  },
  {
    icon: VercelIcon,
    title: 'Vercel Hosting',
    shortDescription: 'Deploying modern apps with lightning-fast Vercel hosting.',
  },
  {
    icon: PostgreSQLIcon,
    title: 'PostgreSQL',
    shortDescription: 'Structured and scalable relational database management.',
  },
  {
    icon: MongoDBIcon,
    title: 'MongoDB',
    shortDescription: 'Flexible NoSQL document database for modern apps.',
  },
]
